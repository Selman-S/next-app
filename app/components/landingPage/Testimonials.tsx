                      ...
                      return(
                          <div key={k} className="card w-full bg-base-100 shadow-xl">
                              <figure className="px-10 pt-10">
                                  <Image alt="sad" width={100} height={100} className="mask w-16 h-16 mask-circle" src="https://images.pexels.com/photos/18169059/pexels-photo-18169059/free-photo-of-peyzaj-su-sari-siluet.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                              </figure>
